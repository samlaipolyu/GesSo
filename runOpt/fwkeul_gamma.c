 ...
 * fwkeul_gamma.c
 *
 * Code generation for function 'fwkeul_gamma'
 *
 */
...
static emlrtRSInfo ac_emlrtRSI = { 18, /* lineNo */
  "fwkeul_gamma",                      /* fcnName */
  "D:\\OneDrive - PolyU\\OneDrive - The Hong Kong Polytechnic University\\1112_code\\fwkeul_gamma.m"/* pathName */
};

static emlrtRSInfo bc_emlrtRSI = { 19, /* lineNo */
  "fwkeul_gamma",                      /* fcnName */
  "D:\\OneDrive - PolyU\\OneDrive - The Hong Kong Polytechnic University\\1112_code\\fwkeul_gamma.m"/* pathName */
};
...
static emlrtRSInfo fc_emlrtRSI = { 30, /* lineNo */
  "fwkeul_gamma",                      /* fcnName */
  "D:\\OneDrive - PolyU\\OneDrive - The Hong Kong Polytechnic University\\1112_code\\fwkeul_gamma.m"/* pathName */
};

static emlrtRSInfo gc_emlrtRSI = { 41, /* lineNo */
  "fwkeul_gamma",                      /* fcnName */
  "D:\\OneDrive - PolyU\\OneDrive - The Hong Kong Polytechnic University\\1112_code\\fwkeul_gamma.m"/* pathName */
};

static emlrtRSInfo hc_emlrtRSI = { 42, /* lineNo */
  "fwkeul_gamma",                      /* fcnName */
  "D:\\OneDrive - PolyU\\OneDrive - The Hong Kong Polytechnic University\\1112_code\\fwkeul_gamma.m"/* pathName */
};
...
static emlrtRSInfo jc_emlrtRSI = { 51, /* lineNo */
  "fwkeul_gamma",                      /* fcnName */
  "D:\\OneDrive - PolyU\\OneDrive - The Hong Kong Polytechnic University\\1112_code\\fwkeul_gamma.m"/* pathName */
};
...
real_T fwkeul_gamma(const emlrtStack *sp, const real_T x[6])
{
  real_T b_x;
  real_T Phi_1;
  real_T theta_2;
...
/* End of code generation (fwkeul_gamma.c) */
